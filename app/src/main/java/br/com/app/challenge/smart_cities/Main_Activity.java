<<<<<<< HEAD:app/src/main/java/br/com/app/challenge/smart_cities/MainActivity.java
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button = (Button)findViewById(R.id.rbnext);

        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent k = new Intent(MainActivity.this, ActivityTipoIncidente.class);
                startActivity(k);
...
>>>>>>> master:app/src/main/java/br/com/app/challenge/smart_cities/Main_Activity.java
